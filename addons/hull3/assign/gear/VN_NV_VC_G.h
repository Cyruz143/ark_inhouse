class VN_NV_VC_G {
    ...
    class Crew : Rifleman {
        primaryWeapon = "vn_mat49_vc";
        uniformRadios[] = {"ACRE_PRC343", "ACRE_PRC152"};
        vestMagazines[] = {{"vn_mat49_vc_mag", 4}};
        backpackMagazines[] = {};
        uniformItems[] = {
            {"ACE_Flashlight_KSF1", 1},
            {"ACE_wirecutter", 1},
    ...
    class SN : Rifleman {
        ...
        handgunWeapon = "vn_tt33";
        primaryWeaponItems[] = {"vn_o_3x_m9130", "vn_b_m38"};
        vestMagazines[] = {
            {"vn_m38_mag", 4},
            {"vn_m38_t_mag", 2},
            {"vn_tt33_mag", 3}
