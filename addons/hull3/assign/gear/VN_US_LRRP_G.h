class VN_US_LRRP_G {
    ...
    class FTL : Leader {
        primaryWeapon = "vn_xm177_camo";
    };

    class AR : Rifleman {
        primaryWeapon = "vn_m60_shorty_camo";
        primaryWeaponItems[] = {};
