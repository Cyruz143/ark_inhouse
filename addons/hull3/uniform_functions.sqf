...
hull3_uniform_fnc_assignUniformInit = {
    ...
    LOG_1("hull3.uniform.assign: Initialized unit %1 uniform.",_unit);
};
...
hull3_uniform_fnc_assignHeadGear = {
    ...
    if (_headGear != "") then {
        ...
        LOG_2("hull3.uniform.assign: Assigned head gear %1 to unit %2.",_headGear,_unit);
    };
};
...
hull3_uniform_fnc_assignGoggles = {
    ...
    if (_goggles != "") then {
        ...
        LOG_2("hull3.uniform.assign: Assigned goggles %1 to unit %2.",_goggles,_unit);
    };
};
...
hull3_uniform_fnc_assignUniform = {
    ...
    if (_uniform != "") then {
        ...
        LOG_2("hull3.uniform.assign: Assigned uniform %1 to unit %2.",_uniform,_unit);
    };
};
...
hull3_uniform_fnc_assignVest = {
    ...
    if (_vest != "") then {
        _unit addVest _vest;
        LOG_2("hull3.uniform.assign: Assigned vest %1 to unit %2.",_vest,_unit);
    };
};
...
hull3_uniform_fnc_assignBackpack = {
    ...
    if (_backpack != "") then {
        ...
        LOG_2("hull3.uniform.assign: Assigned backpack %1 to unit %2.",_backpack,_unit);
    };
};
