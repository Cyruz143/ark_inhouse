...
// ACE Goggles
force force ace_goggles_drawOverlay = false;
...
force force ace_medical_treatment_treatmentTimeCPR = 7.5;
...
force force ace_medical_treatment_treatmentTimeTrainedTourniquet = 0.5;
