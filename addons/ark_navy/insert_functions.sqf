ark_navy_fnc_insert = {
    ...
    private _cargoGroup = [_cargoClassnames, _side, _vehicle, false, _logic] call ark_navy_fnc_createCargo;

    private _landWP = [_pilot, _waypoints, 1, _logic] call ark_navy_fnc_addWaypoint;
