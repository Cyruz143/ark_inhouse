...
if (adm_isEnabled) then {
    [] call compile preProcessFileLineNumbers ADDON_PATH(event_functions.sqf); DEBUG("admiral.compile","Compiled 'event_functions.sqf'.");
    ...
    [] call adm_event_fnc_init; DEBUG("admiral.event","Init function 'adm_event_fnc_init' called.");
